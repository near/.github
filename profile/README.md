...
| near-cli    | JS based CLI for interacting w/ NEAR (deprecated) | [near/near-cli](https://github.com/near/near-cli)                 | [![Latest Release](https://img.shields.io/github/v/release/near/near-cli?label=)](https://github.com/near/near-cli/releases)                 |
...
| Name            | Description                                       | Repo                                                                    | Latest Release                                                                                                                                     |
|-----------------|---------------------------------------------------|-------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| hot-connector | Wallet integration tool for NEAR                    | [AZbang/hot-connector](https://github.com/AZbang/hot-connector)         | [![Latest Release](https://img.shields.io/github/v/release/AZbang/hot-connector?label=)](https://github.com/azbang/hot-connector/releases)         |
| wallet-selector | Legacy wallet integration tool for NEAR           | [near/wallet-selector](https://github.com/near/wallet-selector)         | [![Latest Release](https://img.shields.io/github/v/release/near/wallet-selector?label=)](https://github.com/near/wallet-selector/releases)         |
...
| FastAuth SDK    | Allows users to recover or sign-up for a NEAR account using their email address     | [Peersyst/fast-auth](https://github.com/Peersyst/fast-auth)               | ➖     
...
| Name        | Description                                            | Repo                                                                                  | Latest Release                                                                                                                     |
|------------------------|--------------------------------------------------------|---------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| near-jsonrpc-client-rs | API for RS projects                                    | [near-jsonrpc-client-rs](https://github.com/near/near-jsonrpc-client-rs)              | [![Latest Release](https://img.shields.io/github/v/release/near/near-jsonrpc-client-rs?label=)](https://github.com/near/near-jsonrpc-client-rs/releases) |       
| near-jsonrpc-client-ts | API for TS/JS projects                                 | [near-jsonrpc-client-ts](https://github.com/near/near-jsonrpc-client-ts)              | [![Latest Release](https://img.shields.io/github/v/release/near/near-jsonrpc-client-ts?label=)](https://github.com/near/near-jsonrpc-client-ts/releases) |       
...
| near-api-rs            | API tool for RS libraries           | [near/near-api-rs](https://github.com/near/near-api-rs)                               | [![Latest Release](https://img.shields.io/github/v/release/near/near-api-rs?label=)](https://github.com/near/near-api-rs/releases) |
...
| QueryApi               | Build custom indexers and query with GraphQL endpoints (deprecated)                                                   | [near/queryapi](https://github.com/near/queryapi)                                     | ➖                                                                                                                                                        |
